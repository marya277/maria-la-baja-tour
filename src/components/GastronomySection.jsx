...
const GastronomySection = ({ currentLang, translations }) => {
  ...
  return (
    <section id="gastronomy" className="py-12 md:py-20 bg-gradient-to-br from-amber-100 via-orange-100 to-red-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          {gastronomyData.map((item, index) => (
            <div
              key={item.id}
              className={`group bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer animate-fadeInUp animate-delay-${index * 100}`}
