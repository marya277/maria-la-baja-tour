export const historyData = {
  es: {
    title: "Una historia de resiliencia y esperanza",
    subtitle: "El renacimiento de una tierra que no se rindió",
    paragraphs: [
      "María La Baja es un municipio del departamento de Bolívar que ha enfrentado tiempos difíciles durante el conflicto armado en Colombia. Sin embargo, su gente nunca perdió la fe ni la esperanza en un futuro mejor.",
      "Con el proceso de paz, esta tierra caribeña ha comenzado un proceso de transformación profunda. Las comunidades afrodescendientes e indígenas, pilares fundamentales de su identidad, han liderado iniciativas de reconstrucción del tejido social.",
  ...
  en: {
    ...
    subtitle: "The rebirth of a land that never gave up",
    paragraphs: [
      "María La Baja is a municipality in the department of Bolívar that has faced difficult times during the armed conflict in Colombia. However, its people never lost faith or hope in a better future.",
      "With the peace process, this Caribbean land has begun a process of profound transformation. The Afro-descendant and indigenous communities, fundamental pillars of its identity, have led initiatives to rebuild the social fabric.",
  ...
  fr: {
    ...
    subtitle: "La renaissance d'une terre qui n'a jamais abandonné",
    paragraphs: [
      "María La Baja est une municipalité du département de Bolívar qui a connu des temps difficiles pendant le conflit armé en Colombie. Cependant, son peuple n'a jamais perdu la foi ni l'espoir d'un avenir meilleur.",
      "Avec le processus de paix, cette terre caribéenne a entamé un processus de transformation profonde. Les communautés afro-descendantes et autochtones, piliers fondamentaux de son identité, ont mené des initiatives de reconstruction du tissu social.",
